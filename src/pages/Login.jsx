...
import { BG_IMAGE_URL, USER_AVATAR } from '../utils/constant.js'
...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className="absolute bg-black w-full md:w-4/12 my-35 mx-auto right-0 left-0 flex flex-col p-16 rounded-lg opacity-80 text-white">
